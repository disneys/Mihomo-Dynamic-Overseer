function main(params) {
  ...
  params.rules = [
    ...
    "DOMAIN,sakuradori.dpdns.org,DIRECT",
    "DOMAIN,yyds.215.im,DIRECT",
    "DOMAIN,runanytime.hxi.me,DIRECT",
    "DOMAIN,new-api.abrdns.com,DIRECT",
    "DOMAIN,www.mofas.one,DIRECT",
    "DOMAIN,chybenzun.top,DIRECT",
    "DOMAIN,codexcli.club,DIRECT",
    "DOMAIN,sub.100xlabs.space,DIRECT",
    "DOMAIN,ai.52ccl.cn,DIRECT",
    "DOMAIN,api.7r.fit,DIRECT",
    "DOMAIN,newapi.imagic.eu.org,DIRECT",
    "DOMAIN,metapi.lilililwan.xyz,DIRECT",
    "DOMAIN,www.fuxingapi.com,DIRECT",
    "DOMAIN,jianzhile.vip,DIRECT",
    "DOMAIN,elysiver.h-e.top,DIRECT",
    "DOMAIN,elysia.h-e.top,DIRECT",
    "DOMAIN,123nhh.com,DIRECT",
    "DOMAIN,muyuan.do,DIRECT",
    "DOMAIN,gancaopu.com,DIRECT",
    "DOMAIN,agentrouter.org,DIRECT",
